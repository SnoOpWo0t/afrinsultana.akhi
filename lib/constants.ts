...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    images: [
      ...
      "/RootReach Screenshots/4.png",
      "/RootReach Screenshots/5.png",
      "/RootReach Screenshots/6.png",
      "/RootReach Screenshots/7.png",
      "/RootReach Screenshots/8.png",
      "/RootReach Screenshots/9.png",
      "/RootReach Screenshots/10.png",
      "/RootReach Screenshots/11.png",
      "/RootReach Screenshots/12.png",
      "/RootReach Screenshots/13.png",
      "/RootReach Screenshots/14.png",
      "/RootReach Screenshots/15.png",
      "/RootReach Screenshots/16.png",
      "/RootReach Screenshots/17.png",
      "/RootReach Screenshots/18.png",
      "/RootReach Screenshots/19.png",
      "/RootReach Screenshots/20.png",
      "/RootReach Screenshots/21.png",
      "/RootReach Screenshots/22.png"
    ],
    description:
      "PC-component e-commerce platform featuring a product catalog, CRUD operations, cart functionality, and an admin panel. Note: These screenshots display an older version; the latest RootReach contains many more features.",
    ...
    featured: true,
    image: "/projects/RootReach thumbnail.png",
    category: "Web Development",
    status: "stable",
