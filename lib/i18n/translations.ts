...
export const translations: Record<Locale, TranslationSchema> = {
  ...
  bn: {
    metadata: {
      title: "আফরিন সুলতানা আখি - কম্পিটিটিভ প্রোগ্রামার ও সফটওয়্যার ডেভেলপার",
      description:
        "আফরিন সুলতানা আখির পোর্টফোলিও। তিনি ইউনিভার্সিটি অব এশিয়া প্যাসিফিকের CSE শিক্ষার্থী ও কম্পিটিটিভ প্রোগ্রামার। এখানে ওয়েব ডেভেলপমেন্ট প্রজেক্ট এবং প্রোগ্রামিং অর্জনগুলো তুলে ধরা হয়েছে।",
      ogDescription:
